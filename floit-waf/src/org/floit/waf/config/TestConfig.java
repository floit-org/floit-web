...
public class TestConfig implements java.io.Serializable {
     ...
     */
    private org.floit.waf.config.Includes _includes;
     ...
     */
    private org.floit.waf.config.FlowSet _flowSet;

    /**
     * Collection of page definitions. Each of the page are grouped
     * together to define a page flow.
     */
    private org.floit.waf.config.PageSet _pageSet;
     ...
     */
    public org.floit.waf.config.FlowSet getFlowSet(
    ) {
     ...
     */
    public org.floit.waf.config.Includes getIncludes(
    ) {
     ...
     */
    public org.floit.waf.config.PageSet getPageSet(
    ) {
    ...
    public void setFlowSet(
            final org.floit.waf.config.FlowSet flowSet) {
    ...
    public void setIncludes(
            final org.floit.waf.config.Includes includes) {
    ...
    public void setPageSet(
            final org.floit.waf.config.PageSet pageSet) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.floit.waf.config.TestConfig
     */
    public static org.floit.waf.config.TestConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.floit.waf.config.TestConfig) org.exolab.castor.xml.Unmarshaller.unmarshal(org.floit.waf.config.TestConfig.class, reader);
    }
