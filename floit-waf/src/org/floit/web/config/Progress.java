...
public class Progress implements java.io.Serializable {
     ...
     * Action
     */
    private java.util.List<org.floit.web.config.Action> _actionList;

    /**
     * Simulates browser button functionality.
     */
    private java.util.List<org.floit.web.config.BrowserAction> _browserActionList;
    ...
    public Progress() {
        super();
        this._actionList = new java.util.ArrayList<org.floit.web.config.Action>();
        this._browserActionList = new java.util.ArrayList<org.floit.web.config.BrowserAction>();
    }
    ...
    public void addAction(
            final org.floit.web.config.Action vAction)
    ...
    public void addBrowserAction(
            final org.floit.web.config.BrowserAction vBrowserAction)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.floit.web.config.Action> enumerateAction(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.floit.web.config.BrowserAction> enumerateBrowserAction(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.floit.web.config.Action at the
     * given index
     */
    public org.floit.web.config.Action getAction(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.floit.web.config.Action) _actionList.get(index);
    }
    ...
    public org.floit.web.config.Action[] getAction(
        ...
        org.floit.web.config.Action[] array = new org.floit.web.config.Action[0];
        return (org.floit.web.config.Action[]) this._actionList.toArray(array);
    }
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.floit.web.config.BrowserAction
     * at the given index
     */
    public org.floit.web.config.BrowserAction getBrowserAction(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (org.floit.web.config.BrowserAction) _browserActionList.get(index);
    }
    ...
    public org.floit.web.config.BrowserAction[] getBrowserAction(
        ...
        org.floit.web.config.BrowserAction[] array = new org.floit.web.config.BrowserAction[0];
        return (org.floit.web.config.BrowserAction[]) this._browserActionList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.floit.web.config.Action> iterateAction(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends org.floit.web.config.BrowserAction> iterateBrowserAction(
    ) {
     ...
     */
    public org.floit.web.config.Action removeActionAt(
            final int index) {
        java.lang.Object obj = this._actionList.remove(index);
        return (org.floit.web.config.Action) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public org.floit.web.config.BrowserAction removeBrowserActionAt(
            final int index) {
        java.lang.Object obj = this._browserActionList.remove(index);
        return (org.floit.web.config.BrowserAction) obj;
    }
     ...
     */
    public void setAction(
            final org.floit.web.config.Action[] vActionArray) {
        //-- copy array
        _actionList.clear();
     ...
     */
    public void setBrowserAction(
            final org.floit.web.config.BrowserAction[] vBrowserActionArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.floit.web.config.Progress
     */
    public static org.floit.web.config.Progress unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.floit.web.config.Progress) org.exolab.castor.xml.Unmarshaller.unmarshal(org.floit.web.config.Progress.class, reader);
    }
