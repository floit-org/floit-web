...
public class PageElementType implements java.io.Serializable {
     ...
     * browser.
     */
    private java.util.List<org.floit.web.config.PageElement> _pageElementList;
    ...
    public PageElementType() {
        super();
        this._pageElementList = new java.util.ArrayList<org.floit.web.config.PageElement>();
    }
    ...
    public void addPageElement(
            final org.floit.web.config.PageElement vPageElement)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.floit.web.config.PageElement> enumeratePageElement(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.floit.web.config.PageElement at
     * the given index
     */
    public org.floit.web.config.PageElement getPageElement(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.floit.web.config.PageElement) _pageElementList.get(index);
    }
    ...
    public org.floit.web.config.PageElement[] getPageElement(
        ...
        org.floit.web.config.PageElement[] array = new org.floit.web.config.PageElement[0];
        return (org.floit.web.config.PageElement[]) this._pageElementList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.floit.web.config.PageElement> iteratePageElement(
    ) {
     ...
     */
    public org.floit.web.config.PageElement removePageElementAt(
            final int index) {
        java.lang.Object obj = this._pageElementList.remove(index);
        return (org.floit.web.config.PageElement) obj;
    }
     ...
     */
    public void setPageElement(
            final org.floit.web.config.PageElement[] vPageElementArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.floit.web.config.PageElementType
     */
    public static org.floit.web.config.PageElementType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.floit.web.config.PageElementType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.floit.web.config.PageElementType.class, reader);
    }
