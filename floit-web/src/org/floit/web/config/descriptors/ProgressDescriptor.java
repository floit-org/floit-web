...
public class ProgressDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProgressDescriptor() {
        ...
        //-- _actionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.floit.web.config.Action.class, "_actionList", "Action", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Progress target = (Progress) object;
                    target.addAction( (org.floit.web.config.Action) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.floit.web.config.Action();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("org.floit.web.config.Action");
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
        //-- _browserActionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.floit.web.config.BrowserAction.class, "_browserActionList", "BrowserAction", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Progress target = (Progress) object;
                    target.addBrowserAction( (org.floit.web.config.BrowserAction) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.floit.web.config.BrowserAction();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("org.floit.web.config.BrowserAction");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.floit.org/guitest");
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.floit.web.config.Progress.class;
    }
