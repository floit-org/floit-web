...
public class PageSet implements java.io.Serializable {
     ...
     * Inputs.
     */
    private java.util.List<org.floit.web.config.Page> _pageList;
    ...
    public PageSet() {
        super();
        this._pageList = new java.util.ArrayList<org.floit.web.config.Page>();
    }
     ...
     */
    public void addPage(
            final org.floit.web.config.Page vPage)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.floit.web.config.Page> enumeratePage(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.floit.web.config.Page at the
     * given index
     */
    public org.floit.web.config.Page getPage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.floit.web.config.Page) _pageList.get(index);
    }
    ...
    public org.floit.web.config.Page[] getPage(
        ...
        org.floit.web.config.Page[] array = new org.floit.web.config.Page[0];
        return (org.floit.web.config.Page[]) this._pageList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.floit.web.config.Page> iteratePage(
    ) {
     ...
     */
    public org.floit.web.config.Page removePageAt(
            final int index) {
        java.lang.Object obj = this._pageList.remove(index);
        return (org.floit.web.config.Page) obj;
    }
     ...
     */
    public void setPage(
            final org.floit.web.config.Page[] vPageArray) {
        //-- copy array
        _pageList.clear();
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.floit.web.config.PageSet
     */
    public static org.floit.web.config.PageSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.floit.web.config.PageSet) org.exolab.castor.xml.Unmarshaller.unmarshal(org.floit.web.config.PageSet.class, reader);
    }
